...
for epoch in range(num_epoch):
    ...
    for batch in data_train:
        ...
        train_acc += acc(output[0:batch_size], label[0:batch_size])
    ...
    for batch in data_test:
        ...
        valid_acc += acc(output[0:batch_size], label[0:batch_size])
    ...
    print("Epoch {}: train acc {:g}, train loss {:g}, valid acc {:g}, valid loss {:g}, in {:.1f} sec".format(
